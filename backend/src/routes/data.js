  ...
  app.post(
    ...
    function (req, res) {
      ...
      if (
        ...
        Response.BadParameters(
          res,
          "language and locale value must match /^[A-zÀ-ú0-9 []'()_-]+$/i"
        );
        return;
      }
  ...
  app.post(
    ...
    function (req, res) {
      ...
      if (
        ...
        Response.BadParameters(
          res,
          "name and locale value must match /^[A-zÀ-ú0-9 []'()_-]+$/i"
        );
        return;
      }
  ...
  app.put(
    ...
    function (req, res) {
      for (var i = 0; i < req.body.length; i++) {
        ...
        if (
          !utils.validFilename(auditType.name) ||
          !utils.validFilename(auditType.locale)
        ) {
          Response.BadParameters(
            res,
            "name and locale value must match /^[A-zÀ-ú0-9 []'()_-]+$/i"
  ...
  app.post(
    ...
    function (req, res) {
      ...
      if (!utils.validFilename(req.body.name)) {
        Response.BadParameters(
          res,
          "name value must match /^[A-zÀ-ú0-9 []'()_-]+$/i"
        );
        return;
      }
      ...
      vulnCat.description = req.body.description || "";
      ...
      for (var i = 0; i < req.body.length; i++) {
        ...
        for (var j = 0; j < vulnCat.fields.length; j++) {
          ...
          if (!field.fieldType || !field.label) {
            Response.BadParameters(
              res,
              "Missing required parameters: fields.fieldType, fields.label"
            );
            return;
          }
          if (
            !utils.validFilename(field.fieldType) ||
            !utils.validFilename(field.label)
          ) {
            Response.BadParameters(
              res,
              "fieldType and label value must match /^[A-zÀ-ú0-9 []'()_-]+$/i"
            );
            return;
          }
        }
  ...
  app.post(
    ...
    function (req, res) {
      if (!req.body.field || !req.body.name || !req.body.locale) {
        Response.BadParameters(
          res,
          "Missing required parameters: field, name, locale"
        );
        return;
      }
      if (
        ...
        Response.BadParameters(
          res,
          "name and field value must match /^[A-zÀ-ú0-9 []'()_-]+$/i "
        );
        return;
      }
    ...
    function (req, res) {
      for (var i = 0; i < req.body.length; i++) {
        ...
        if (
          ...
          !utils.validFilename(section.locale)
        ) {
          Response.BadParameters(
            res,
            "name and field value must match /^[A-zÀ-ú0-9 []'()_-]+$/i"
    ...
    function (req, res) {
      for (var i = 0; i < req.body.length; i++) {
        ...
        if (
          ...
          Response.BadParameters(
            res,
            "label and fieldType value must match /^[A-zÀ-ú0-9 []'()_-]+$/i"
          );
          return;
        }
      }
