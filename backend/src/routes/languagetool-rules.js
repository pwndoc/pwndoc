...
module.exports = function(app) {
    ...
    // ---------------------------
    app.get("/api/languagetool-rules/languages", acl.hasPermission("proofing-rules:read"), async (req, res) => {
        try {
    ...
    // ---------------------------
    app.get("/api/languagetool-rules", acl.hasPermission('proofing-rules:read'), async (req, res) => {
    ...
    // ---------------------------
    app.get("/api/languagetool-rules/:id", acl.hasPermission('proofing-rules:read'), async (req, res) => {
    ...
    // Create a new rule
    // ---------------------------
    app.post("/api/languagetool-rules", acl.hasPermission("proofing-rules:create"), async (req, res) => {
    ...
    // Delete a rule
    // ---------------------------
    app.delete("/api/languagetool-rules/:id", acl.hasPermission("proofing-rules:delete"), async (req, res) => {
        const ruleId = req.params.id;
    ...
    // ---------------------------
    app.post("/api/languagetool-rules/reload", acl.hasPermission("proofing-rules:update"), async (req, res) => {
        try {
    ...
    // ---------------------------
    app.post("/api/languagetool-rules/restart", acl.hasPermission("proofing-rules:update"), async (req, res) => {
        try {
            const result = await callLTApi('POST', '/api/rules/restart');
            Response.Ok(res, {
