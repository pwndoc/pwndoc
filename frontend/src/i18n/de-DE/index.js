export default {
    ...
    btn: {
        ...
        dismissAllUpdates: 'Alle Vorschläge auf {language} verwerfen',
        dismissProposal: 'Vorschlag verwerfen',
        dismissEveryUpdate: 'Alle Vorschläge verwerfen',
    ...
    tooltip: {
        vulnerabilityUpdates: 'Aktualisierungsvorschläge für diese Schwachstelle prüfen',
        ...
        delete: 'Löschen',
        download: 'Download',
        auditQa: 'QA-Panel anzeigen',
        vulnerabilityQa: 'QA-Panel anzeigen',
    },
    msg: {
        ...
        updatesDismissedOk: 'Aktualisierungsvorschläge erfolgreich verworfen',
        confirmDismissUpdates: 'Verwerfen bestätigen',
        updatesWillBeDismissed: 'Alle Vorschläge auf {language} werden endgültig gelöscht',
        updateWillBeDismissed: 'Der Vorschlag von {creator} wird endgültig gelöscht',
        everyUpdateWillBeDismissed: 'Alle Aktualisierungsvorschläge dieser Schwachstelle werden in allen Sprachen endgültig gelöscht',
    ...
    logout: 'Abmelden',
    login: 'Anmelden',
    ssoLoginFailed: 'Die einmalige Anmeldung ist fehlgeschlagen. Versuchen Sie es erneut oder wenden Sie sich an einen Administrator.',
    ssoAccessDenied: 'Ihr Konto ist nicht für den Zugriff auf PwnDoc autorisiert.',
    noAuthenticationMethod: 'Es ist keine Authentifizierungsmethode aktiviert.',
    ...
    createNewVulnerability: 'Neue Schwachstelle erstellen',
    filters: 'Filter',
    views: 'Ansichten',
    or: 'oder',
    reset: 'Zurücksetzen',
    createdBy: 'Erstellt von',
    filtersApplied: 'Filter aktiv',
    unsavedChangesOnly: 'Nur ungespeicherte Änderungen',
    noMatchingRecords: 'Keine passenden Einträge gefunden',
    selectVulnerability: 'Wählen Sie eine Schwachstelle zum Anzeigen oder Bearbeiten',
    selectVulnerabilityHint: 'Wählen Sie eine Schwachstelle aus der Liste links, um Details, CVSS-Score, Referenzen und mehr zu sehen.',
    total: 'Gesamt',
    ...
    current: 'Aktuell',
    proposalsCount: '{count} Vorschlag | {count} Vorschläge',
    reviewVulnerabilityProposals: 'Schwachstellen-Vorschläge prüfen',
    ...
    auditQa: {
        infos: 'Infos',
        title: 'QA-Prüfung',
        loading: 'QA-Ergebnisse werden geladen…',
        running: 'QA-Prüfungen werden ausgeführt...',
        runInProgress: 'QA läuft… gestartet {time}',
        runInProgressNoTime: 'QA läuft…',
        runInProgressProgrammatic: 'Integrierte Prüfungen laufen… gestartet {time}',
        runInProgressProgrammaticNoTime: 'Integrierte Prüfungen laufen…',
        runInProgressAi: 'KI-Prüfungen laufen… gestartet {time}',
        runInProgressAiNoTime: 'KI-Prüfungen laufen…',
        failed: 'QA-Prüfung des Berichts konnte nicht ausgeführt werden',
        previousProgrammaticRun: 'Daten aus integrierten Prüfungen werden angezeigt',
        previousProgrammaticRunAt: 'Daten aus integrierten Prüfungen werden angezeigt ({date})',
        previousAiRun: 'Daten aus KI-Prüfungen werden angezeigt',
        previousAiRunAt: 'Daten aus KI-Prüfungen werden angezeigt ({date})',
        runSourceProgrammatic: 'Integrierte Prüfungen',
        runSourceAi: 'KI-Prüfungen',
        lastRun: 'Letzte Ausführung',
        noResultsYet: 'Noch keine QA-Ergebnisse. Wählen Sie oben eine Ausführungsoption.',
        outdatedBanner: 'Diese Ergebnisse sind veraltet — der Inhalt hat sich seit der letzten Ausführung geändert. Eine erneute Ausführung wird empfohlen.',
        runProgrammatic: 'Integrierte Prüfungen ausführen',
        runAi: 'KI-Prüfungen ausführen',
        runAll: 'Integrierte + KI-Prüfungen ausführen',
        runAgain: 'Erneut ausführen',
        runAgainScoped: 'Erneut ausführen {scope}',
        scopeProgrammatic: 'Integrierte Prüfungen',
        scopeAi: 'KI-Prüfungen',
        scopeAll: 'Integrierte + KI-Prüfungen',
        errors: 'Fehler',
        warnings: 'Warnungen',
        total: 'Gesamt',
        filterAll: 'Alle',
        noIssues: 'Keine Probleme markiert',
        goToFinding: 'Zum Ergebnis gehen',
        goToSection: 'Zum Abschnitt gehen',
        aiReview: 'KI-Prüfung — vor dem Handeln überprüfen',
        showMore: '{count} weitere anzeigen',
        category: {
            completeness: 'Vollständigkeit',
            redaction: 'Redaktion',
            customer: 'Kunde',
            instructions: 'QA-Anweisungen',
            references: 'Referenzen',
            imageCaptions: 'Bildbeschriftungen',
            duplicates: 'Duplikate',
            aiDuplicates: 'KI-Duplikate',
            aiUnlinkedTranslations: 'Nicht verknüpfte Übersetzungen',
            other: 'Sonstiges'
        },
        location: {
            ...
            network: 'Netzwerk',
            report: 'Bericht',
            untitledFinding: 'Unbenanntes Ergebnis'
        }
    },
    vulnerabilityQa: {
        titleSingle: 'QA-Prüfung',
        titleAll: 'QA-Prüfung der Schwachstellendatenbank',
        untitled: 'Unbenannte Schwachstelle',
        loading: 'QA-Ergebnisse werden geladen…',
        running: 'Schwachstellen werden auf Vollständigkeit, doppelte Einträge, Referenzlinks und Inhaltsrichtlinien geprüft...',
        failed: 'QA-Prüfung der Schwachstellen konnte nicht ausgeführt werden',
        recheckFailed: 'Die Schwachstelle konnte nicht erneut geprüft werden',
        showReview: 'QA-Prüfung anzeigen',
        hideReview: 'QA-Prüfung ausblenden',
        reviewedCount: '{count} Schwachstellen für die ausgewählte Sprache geprüft.',
        runAllPreview: 'Prüft alle {count} Schwachstellen in {language} mit Vollständigkeits-, Duplikat- und KI-Prüfungen. Läuft im Hintergrund — Sie können weiterarbeiten.',
        progressTemplates: '{processed} von {total} Schwachstellen geprüft…',
        progressCatalog: 'Schwachstellenübergreifende Prüfungen: {done} von {total}…',
        reusedCached: '{count} unveränderte(s) Ergebnis(se) wiederverwendet',
        partialReport: '{checked} von {total} Schwachstellen geprüft — führen Sie die QA erneut aus, um die verbleibenden zu prüfen.',
        cancel: 'Abbrechen',
        recheckHint: 'Prüft nur diese Schwachstelle erneut. Schwachstellenübergreifende Prüfungen (Duplikate, Übersetzungen) sind nicht enthalten — verwenden Sie dafür \'Erneut ausführen\'.',
        recheckUpToDate: 'Aktuell — keine Änderungen seit der letzten QA-Ausführung',
        runAgainHint: 'Es werden nur veraltete Schwachstellen erneut geprüft',
        rowOutdated: 'veraltet',
        catalogGroup: 'Schwachstellenübergreifende Prüfungen',
        goToVulnerability: 'Zur Schwachstelle gehen',
        resolve: 'Diese Schwachstelle beheben',
        resolveIssue: 'Dieses Problem beheben',
        ...
        filterRows: 'Nach Schwachstellentitel filtern...',
        resolveFailed: 'Der Lösungsstatus konnte nicht aktualisiert werden',
        clearFilters: 'Filter zurücksetzen',
        notFoundInList: 'Diese Schwachstelle befindet sich nicht mehr in der Datenbank — führen Sie die QA erneut aus, um den Bericht zu aktualisieren.',
        notVisibleWithFilters: 'Diese Schwachstelle ist durch die aktuellen Filter ausgeblendet.',
        location: {
            database: 'Schwachstellendatenbank',
            global: 'Global'
        }
    },
    aiIntegration: {
        ...
        qa: {
            ...
            aiChecksDisabledChip: 'Deaktiviert',
            aiChecksDisabledBefore: 'Die KI-Integration ist deaktiviert. Aktivieren Sie sie in den',
            aiChecksDisabledLink: 'Einstellungen',
            aiChecksDisabledAfter: 'um KI-gestützte Prüfungen auszuführen.',
    ...
    aiChat: {
        ...
        startPrompt: 'Beschreiben Sie, wie Sie den ausgewählten Text ändern möchten.',
        reviewDefaultPrompt: 'Wählen Sie eine Aufforderung oder fragen Sie etwas.',
        defaultPromptPlaceholder: 'Fragen Sie etwas',
        askAnything: 'Fragen Sie etwas',
        defaultPromptOption: 'Feldstandard',
        promptSelectLabel: 'Aufforderungsvorlage',
        howCanIHelp: 'Wie kann ich helfen?',
        quickPrompts: 'Schnelle Aufforderungen',
        quickPromptsHint: 'Beginnen Sie mit dem Feldstandard oder wählen Sie eine wiederverwendbare Aufforderung.',
        searchPrompts: 'Aufforderungen suchen...',
        searchResults: 'Suchergebnisse',
        fieldPrompt: 'Feldaufforderung',
        defaultPromptHint: 'Verwendet die für dieses Feld vorkonfigurierten Anweisungen.',
        usePrompt: 'Verwenden',
        recentPrompts: 'Zuletzt verwendet',
        allPrompts: 'Alle Aufforderungen',
        browsePrompts: 'Aufforderungen durchsuchen',
        noPromptsFound: 'Keine Aufforderungen entsprechen Ihrer Suche.',
        applyField: 'Auf Feld anwenden',
        previewChanges: 'Änderungen anzeigen',
        originalResponse: 'Ursprüngliche Antwort',
        ...
        closeWhileGeneratingMessage: 'Der Inhalt wird noch generiert. KI-Panel trotzdem schließen?',
        discardAiSessionTitle: 'KI-Sitzung verwerfen?',
        discardAiSessionMessage: 'Das Feld wird entsperrt und die aktuelle KI-Unterhaltung geht verloren.',
