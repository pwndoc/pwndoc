export default {
    ...
    msg: {
        ...
        updateDataRetention: 'Modify the data retention policy',
        updateDataRetentionConfirm: 'Do you really want to modify the data retention policy? This will delete all reports older than the new policy.',
    ...
    dataRetentionDescription: 'Number of days before deletion of reports (set to 0 to disable this policy)',
    defaultDataRetentionDays: 'Number of days',
    easy: 'Easy',
    medium: 'Medium',
    complex: 'Complex',
    low: 'Low',
