export default {
    ...
    btn: {
        ...
        dismissAllUpdates: 'Dismiss all {language} proposals',
        dismissProposal: 'Dismiss selected proposal',
        dismissEveryUpdate: 'Dismiss all proposals',
    ...
    tooltip: {
        ...
        auditQa: 'Show QA panel',
        vulnerabilityQa: 'Show QA panel',
    ...
    msg: {
        ...
        updatesDismissedOk: 'Update proposals dismissed successfully',
        confirmDismissUpdates: 'Confirm dismissal',
        updatesWillBeDismissed: 'All {language} update proposals will be permanently deleted',
        updateWillBeDismissed: 'The proposal from {creator} will be permanently deleted',
        everyUpdateWillBeDismissed: 'All update proposals for this vulnerability will be permanently deleted, in every language',
    ...
    apiKeys: {
        title: 'API Keys',
        description: 'API Keys allow automated scripts, CLI tools, and integrations to authenticate with the PwnDoc API without needing your username and password.',
        ...
        warningCopyNow: 'Please copy your new API key now. For security reasons, it will never be displayed again.',
        copy: 'Copy to clipboard',
        copied: 'API Key copied to clipboard',
        nameRequired: 'Key name is required',
        createdOk: 'API Key generated successfully',
    ...
    createNewVulnerability: 'Create a new vulnerability',
    filters: 'Filters',
    views: 'Views',
    or: 'or',
    reset: 'Reset',
    ...
    unsavedChangesOnly: 'Unsaved changes',
    noMatchingRecords: 'No matching records found',
    selectVulnerability: 'Select a vulnerability to view or edit',
    selectVulnerabilityHint: 'Choose a vulnerability from the list on the left to see its details, CVSS score, references and more.',
    total: 'Total',
    ...
    current: 'Current',
    proposalsCount: '{count} proposal | {count} proposals',
    reviewVulnerabilityProposals: 'Review Vulnerability Proposals',
    ...
    auditQa: {
        ...
        runInProgressProgrammatic: 'Programmatic checks in progress… started {time}',
        runInProgressProgrammaticNoTime: 'Programmatic checks in progress…',
        runInProgressAi: 'AI checks in progress… started {time}',
        runInProgressAiNoTime: 'AI checks in progress…',
        failed: 'Unable to run report QA review',
        previousProgrammaticRun: 'Showing data from built-in checks',
        previousProgrammaticRunAt: 'Showing data from built-in checks ({date})',
        previousAiRun: 'Showing data from AI checks',
        previousAiRunAt: 'Showing data from AI checks ({date})',
        runSourceProgrammatic: 'Built-in checks',
        ...
        runAi: 'Run AI Checks',
        runAll: 'Run built-in + AI checks',
        runAgain: 'Run again',
        runAgainScoped: 'Run again {scope}',
        scopeProgrammatic: 'Built-in checks',
        scopeAi: 'AI checks',
        scopeAll: 'Built-in + AI checks',
        errors: 'Errors',
        warnings: 'Warnings',
        infos: 'Infos',
        total: 'Total',
        ...
        category: {
            ...
            aiDuplicates: 'AI duplicates',
            aiUnlinkedTranslations: 'Unlinked translations',
            other: 'Other'
        },
        location: {
    ...
    vulnerabilityQa: {
        ...
        recheckFailed: 'Unable to recheck the vulnerability',
        showReview: 'Show QA review',
        hideReview: 'Hide QA review',
        reviewedCount: 'Reviewed {count} vulnerabilities for the selected language.',
        runAllPreview: 'Reviews all {count} vulnerabilities in {language} with completeness, duplicate, and AI checks. Runs in the background — you can keep working.',
        progressTemplates: 'Checked {processed} of {total} vulnerabilities…',
        progressCatalog: 'Cross-vulnerability checks: {done} of {total}…',
        reusedCached: '{count} unchanged result(s) reused',
        partialReport: 'Checked {checked} of {total} vulnerabilities — run QA again to review the remaining ones.',
        cancel: 'Cancel',
        recheckHint: 'Re-checks this vulnerability only. Cross-vulnerability checks (duplicates, translations) aren\'t included — use "Run again" for those.',
        recheckUpToDate: 'Up to date — no changes since the last QA run',
        runAgainHint: 'Only outdated vulnerabilities are re-checked',
        rowOutdated: 'outdated',
        catalogGroup: 'Cross-vulnerability checks',
        goToVulnerability: 'Go to vulnerability',
        resolve: 'Resolve this vulnerability',
        resolveIssue: 'Resolve this issue',
        ...
        filterAllStatus: 'All',
        filterRows: 'Filter by vulnerability title...',
        resolveFailed: 'Unable to update the resolved state',
    ...
    aiChat: {
        ...
        quickPromptsHint: 'Start with the field default or choose a reusable prompt.',
        ...
        leaveWhileGeneratingMessage: 'Content is still being generated. Leaving now will cancel the current AI request.',
        ...
        discardAiSessionMessage: 'The current AI conversation will be lost.',
        ...
        anchorLost: 'The original selection could not be tracked. Reselect the text and try again, or copy the response manually.',
