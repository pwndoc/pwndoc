export default {
    ...
    logout: 'Logout',
    login: 'Login',
    ssoLoginFailed: 'Single sign-on failed. Please try again or contact an administrator.',
    ssoAccessDenied: 'Your account is not authorized to access PwnDoc.',
    noAuthenticationMethod: 'No authentication method is enabled.',
    username: 'Username',
    password: 'Password',
