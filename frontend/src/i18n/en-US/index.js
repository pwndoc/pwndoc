export default {
    ...
    auditQa: {
        title: 'QA Review',
        running: 'Reviewing report completeness, reference links, customer alignment, and content guidelines...',
        ...
        cachedResult: 'Showing the previous QA review. Edit the report to run QA again.',
        cachedResultAt: 'Showing the previous QA review from {date}. Edit the report to run QA again.',
        aiReview: 'AI review',
        category: {
    ...
    aiChat: {
        ...
        reviewDefaultPrompt: 'Review and edit the default prompt below, then send to generate.',
        defaultPromptPlaceholder: 'Edit the generation prompt...',
        ...
        applied: 'AI change applied to selection (not saved yet)',
        appliedField: 'AI draft applied to field (not saved yet)',
