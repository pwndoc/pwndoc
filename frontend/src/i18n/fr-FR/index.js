export default {
    ...
    msg: {
        ...
        updateDataRetention: 'Modification de la politique de rétention des données',
        updateDataRetentionConfirm: 'Souhaitez-vous vraiment modifier la politique de rétention des données ? Cela supprimera l\'ensemble des rapports plus anciens que la politique définie.',
    ...
    dataRetentionDescription: 'Nombre de jours après lequel supprimer les rapports (0 pour ne jamais supprimer)',
    defaultDataRetentionDays: 'Nombre de jours',
    easy: 'Facile',
    medium: 'Moyenne',
    complex: 'Complexe',
    low: 'Basse',
