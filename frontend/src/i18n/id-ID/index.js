export default {
    ...
    listOfLanguages: 'Daftar Bahasa',
    editLanguages: 'Edit Bahasa',
    locale: 'Locale',
    ...
    current: 'Current',
    languageAddFromRight: 'Bahasa (Tambah dari kanan)',
    languageMoveToLeft: 'Bahasa (Pindah ke kiri)',
    merge: 'Merge',
    goBack: 'Go back',
