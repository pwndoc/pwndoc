export default {
    ...
    btn: {
        ...
        dismissAllUpdates: '忽略所有{language}提案',
        dismissProposal: '忽略所选提案',
        dismissEveryUpdate: '忽略所有提案',
    ...
    tooltip: {
        vulnerabilityUpdates: '查看此漏洞的更新提案',
    ...
    msg: {
        ...
        updatesDismissedOk: '更新提案已忽略',
        confirmDismissUpdates: '确认忽略',
        updatesWillBeDismissed: '所有{language}更新提案将被永久删除',
        updateWillBeDismissed: '{creator} 的提案将被永久删除',
        everyUpdateWillBeDismissed: '该漏洞在所有语言下的全部更新提案都将被永久删除',
    ...
    logout: '退出登录',
    login: '登录',
    ssoLoginFailed: '单点登录失败。请重试或联系管理员。',
    ssoAccessDenied: '您的账户无权访问 PwnDoc。',
    noAuthenticationMethod: '未启用任何身份验证方法。',
    username: '用户名',
    password: '密码',
    ...
    createNewVulnerability: '创建新漏洞',
    filters: '筛选',
    views: '视图',
    or: '或',
    reset: '重置',
    createdBy: '创建者',
    filtersApplied: '个筛选条件已应用',
    unsavedChangesOnly: '仅显示未保存的更改',
    noMatchingRecords: '未找到匹配的记录',
    selectVulnerability: '选择一个漏洞进行查看或编辑',
    selectVulnerabilityHint: '从左侧列表中选择一个漏洞，查看其详细信息、CVSS 评分、参考资料等。',
    total: '总共',
    ...
    current: '当前的',
    proposalsCount: '{count} 条提案',
    reviewVulnerabilityProposals: '审阅漏洞提案',
    currentVersion: '当前版本',
    ...
    auditQa: {
        ...
        loading: '正在加载 QA 结果…',
        running: '正在运行 QA 检查...',
        runInProgress: 'QA 进行中… 开始于 {time}',
        runInProgressNoTime: 'QA 进行中…',
        runInProgressProgrammatic: '内置检查进行中… 开始于 {time}',
        runInProgressProgrammaticNoTime: '内置检查进行中…',
        runInProgressAi: 'AI 检查进行中… 开始于 {time}',
        runInProgressAiNoTime: 'AI 检查进行中…',
        failed: '无法运行报告 QA 审查',
        previousProgrammaticRun: '显示内置检查的数据',
        previousProgrammaticRunAt: '显示内置检查的数据（{date}）',
        previousAiRun: '显示 AI 检查的数据',
        previousAiRunAt: '显示 AI 检查的数据（{date}）',
        runSourceProgrammatic: '内置检查',
        runSourceAi: 'AI 检查',
        lastRun: '上次运行',
        noResultsYet: '暂无 QA 结果。请在上方选择运行方式。',
        outdatedBanner: '这些结果已过期——自上次运行以来内容已更改。建议重新运行。',
        runProgrammatic: '运行内置检查',
        runAi: '运行 AI 检查',
        runAll: '运行内置 + AI 检查',
        runAgain: '重新运行',
        runAgainScoped: '重新运行 {scope}',
        scopeProgrammatic: '内置检查',
        scopeAi: 'AI 检查',
        scopeAll: '内置 + AI 检查',
        errors: '错误',
        warnings: '警告',
    ...
    vulnerabilityQa: {
        ...
        untitled: '未命名漏洞',
        loading: '正在加载 QA 结果…',
        running: '正在审查漏洞的完整性、重复条目、参考链接及内容规范...',
        failed: '无法运行漏洞 QA 审查',
        recheckFailed: '无法重新检查该漏洞',
        showReview: '显示 QA 审查',
        hideReview: '隐藏 QA 审查',
        reviewedCount: '已针对所选语言审查 {count} 个漏洞。',
        runAllPreview: '使用完整性、重复项和 AI 检查审查 {language} 中的全部 {count} 个漏洞。在后台运行——您可以继续工作。',
        progressTemplates: '已检查 {total} 个漏洞中的 {processed} 个…',
        progressCatalog: '跨漏洞检查：{total} 项中的 {done} 项…',
        reusedCached: '复用了 {count} 个未更改的结果',
        partialReport: '已检查 {total} 个漏洞中的 {checked} 个——请重新运行 QA 以审查其余漏洞。',
        cancel: '取消',
        recheckHint: '仅重新检查此漏洞。不包括跨漏洞检查（重复项、翻译）——请使用“重新运行”来执行这些检查。',
        recheckUpToDate: '已是最新——自上次 QA 运行以来无更改',
        runAgainHint: '仅重新检查已过期的漏洞',
        rowOutdated: '已过期',
        catalogGroup: '跨漏洞检查',
        goToVulnerability: '跳转到漏洞',
        resolve: '解决此漏洞',
        resolveIssue: '解决此问题',
        unresolve: '标记为未解决',
        resolvedLabel: '已解决',
        ...
        filterAllStatus: '全部',
        filterRows: '按漏洞标题筛选...',
        resolveFailed: '无法更新解决状态',
        clearFilters: '清除筛选',
        notFoundInList: '该漏洞已不在库中——请重新运行 QA 以刷新报告。',
        notVisibleWithFilters: '该漏洞已被当前筛选条件隐藏。',
        location: {
            database: '漏洞库',
            global: '全局'
        }
    ...
    aiIntegration: {
        ...
        qa: {
            ...
            aiChecksDisabledChip: '已禁用',
            aiChecksDisabledBefore: 'AI 集成已禁用。请在',
            aiChecksDisabledLink: '设置',
            aiChecksDisabledAfter: '中启用以运行 AI 检查。',
    ...
    aiChat: {
        ...
        defaultPromptPlaceholder: '提出任何问题',
        askAnything: '提出任何问题',
        defaultPromptOption: '字段默认值',
        promptSelectLabel: '提示词模板',
        howCanIHelp: '我能帮您什么？',
        quickPrompts: '快捷提示词',
        quickPromptsHint: '使用字段默认提示词，或选择可复用的提示词。',
        searchPrompts: '搜索提示词...',
        searchResults: '搜索结果',
        fieldPrompt: '字段提示词',
        defaultPromptHint: '使用为此字段配置的预定义指令。',
        usePrompt: '使用',
        recentPrompts: '最近使用',
        allPrompts: '所有提示词',
        browsePrompts: '浏览提示词',
        noPromptsFound: '没有符合搜索条件的提示词。',
        applyField: '应用到字段',
        previewChanges: '预览更改',
        ...
        closeWhileGeneratingMessage: '内容仍在生成中。仍要关闭 AI 面板吗？',
        discardAiSessionTitle: '放弃 AI 会话？',
        discardAiSessionMessage: '该字段将被解锁，当前 AI 对话将丢失。',
