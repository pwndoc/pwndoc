...
export default {
  ...
  methods: {
    ...
    createAudit: function() {
      this.cleanErrors();
      if (!this.currentAudit.name) this.errors.name = "Name required";
      ...
      return (
        ...
        rows.filter((row) => {
          var name = (row.name || "")
            ...
            .normalize("NFD")
            .replace(/[\u0300-\u036f]/g, "");
          var nameTerm = (terms.name || "")
            .toLowerCase()
            .normalize("NFD")
            .replace(/[\u0300-\u036f]/g, "");

          var language = row.language
            ? this.convertLocale(row.language).toLowerCase()
            : "";
          ...
          var users = this.convertParticipants(row)
            .toLowerCase()
            .normalize("NFD")
            .replace(/[\u0300-\u036f]/g, "");
          var usersTerm = (terms.users || "")
            .toLowerCase()
            .normalize("NFD")
            .replace(/[\u0300-\u036f]/g, "");
          ...
          return (
            ...
            ((this.myAudits && users.indexOf(username) > -1) ||
              !this.myAudits) &&
