<template>
    <div class="row">
        <div class="col-xl-8 col-12 offset-xl-2 q-pa-md profile-form-body">
            <div class="profile-form-section">
                <div class="profile-form-section__header">
...
.body--dark .profile-form-section {
    background: #1e1e1e;
