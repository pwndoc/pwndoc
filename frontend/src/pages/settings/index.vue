                    ...
                    <q-card-section>
                        ...
                        <div v-if="settings.report.public.enableSpellCheck" class="q-mt-md">
                            <q-item>
                                <q-item-section class="col-md-6">
                                    <q-input
                                        v-model="settings.report.private.languageToolUrl"
                                        :label="$t('languageToolUrl')"
                                        :hint="$t('languageToolUrlHint')"
                            ...
                            <q-item>
                                <q-item-section class="col-md-6">
                                    <q-input
                                        v-model="settings.report.private.languageToolUsername"
                                        :label="$t('languageToolUsername')"
                            ...
                            <q-item>
                                <q-item-section class="col-md-6">
                                    ...
                                    />
                                    <div v-if="ltConnectionResult" class="q-mt-sm">
                ...
                >
                    ...
                    <template v-slot:body-cell-action="props">
                        <q-td style="width:1px">
                            ...
                            <q-btn
                            v-if="userStore.isAllowed('backups:delete')"
                            size="sm" 
                            flat 
                            color="negative" 
                            icon="fa fa-trash" 
