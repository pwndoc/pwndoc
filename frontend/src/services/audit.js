...
export default {
  ...
  generateAuditReport: function(auditId, format = "") {
    var formatPath = format === "" ? format : "/" + format;
    return Vue.prototype.$axios.get(`audits/${auditId}/generate${formatPath}`, {responseType: 'blob'})
  }
}